...
public class BasicDocument extends Document 
{
	...
	{
		List<String> numberOfWords = getTokens("[a-zA-Z]+");
		//System.out.println("numwords:" + numberOfWords.size());
		//TODO: Implement this method in week 2 according to the comments above.  
		// See the Module 2 support videos if you need help.
	    return numberOfWords.size();
	}
	...
	{
		List<String> numberOfSentences = getTokens("[^!?.]+");
		//System.out.println("numsentences:" + numberOfSentences.size());
	    //TODO: Implement this method.  See the Module 2 support videos 
        // if you need help.
        return numberOfSentences.size();
	}
	...
	public int getNumSyllables()
	{
		...
		//System.out.println("number of syl:" + numberOfSyllables);
